...
const Details = () => {
  ...
  return (
    <div className='p-4 w-full flex gap-12 flex-wrap justify-evenly mt-6'>
        ...
        <img className='md:h-[34rem] w-96 rounded-2xl' src={data.image} />
        <div className='md:w-1/2 relative overflow-hidden p-4'>
            ...
            <h1 className='md:text-4xl text-3xl font-semibold text-gray-200'>{data.title} <span className='text-red-700'>({data.year})</span></h1>
            <ReactStars
                size={30}
                half={true}
                ...
                edit={false}
             />
            <p className='mt-6 md:text-xl text-gray-300'>{data.description}</p>
        </div>
        </>
        }
